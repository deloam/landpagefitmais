            ...
            <div className="container mx-auto px-6">
                ...
                <div className="text-center">
                    <a
                        ...
                        className="bg-fit-orange text-white font-bold py-4 px-8 rounded-full text-lg uppercase hover:bg-orange-600 transition-all duration-300 shadow-lg transform hover:scale-105 inline-flex items-center"
                    >
